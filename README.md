...
below example there are two templates {{fizz}} and {{buzz}}. A template is
indicated by an opening character sequences and closing character sequences. In
...
| json.readFile      | support all the features of the main yaml method but with the addition to supporting file paths                   |
...
yaml string. Just like the json method it accepts either a json object or yaml
...
| yaml.readFile      | support all the features of the main yaml method but with the addition to supporting file paths                   |
...
the json paths used in the templates. You won't be able to pull data from the
actual file itself.
...
| file.readFile      | support all the features of the main file method but with the addition to supporting file paths async returns promise  |
...
arguments order, and type, then categorized, resolve, and order them to fit the
